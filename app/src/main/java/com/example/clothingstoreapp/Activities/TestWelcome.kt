...
import com.example.clothingstoreapp.Activities.Adapter.SlideAdapter
import com.example.clothingstoreapp.Activities.model.slideItem
import com.example.clothingstoreapp.R
import com.example.clothingstoreapp.databinding.WelcomeLayoutTestBinding

class TestWelcome : AppCompatActivity() {
    private lateinit var binding : WelcomeLayoutTestBinding
    private val slides = listOf(
        slideItem(R.drawable.image_welcome_layout,"Seamles Shopping Experience" ,"Shop easy, fast, and hassle-free"),
        slideItem(R.drawable.img_item_wishlist,"Wishlist : Where Fashion Dreams Begin","Start your style journey with Wishlist"),
        slideItem(R.drawable.img_welcome_cart,"Swift and Reliable Delivery","Fast, secure, and always on time")
    )
    private var currentIndex = 0
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        // khởi tạo binding
        binding = WelcomeLayoutTestBinding.inflate(layoutInflater)
